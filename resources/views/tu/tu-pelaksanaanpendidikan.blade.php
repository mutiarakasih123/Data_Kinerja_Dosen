...
<html lang="en">
  ...
  @include('tu.tu-navbar') 
	...
	<div class="container-fluid">
		...
		@csrf
		<center> <h5> Input Data Dosen Pengajar </h5> </center>
  ...
  <div class="form-group row">
		...
		<div class="col-sm-10">
			<input type="integer"  class="form-control" "="" style=" width: 50%;">
    	</div>
  </div>
	...
	<td>
		<a class="btn btn-sm btn-primary" href="inputdetail" style=" margin-left: 475px;">Simpan</a>
